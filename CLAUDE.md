...
<!-- ────────────────────────────────────────────────────────── -->
# CLAUDE.md — Project Intelligence for trustmatch
...
- 40 dependencies tracked
- Project maturity: new (15%)
...
- **Structure**: layer-based
- **Top-level dirs**: assets, server, src, workflows
- **Files**: 168 files across 34 directories
...
## Project Map
### Structure: layer-based
Top-level directories: `assets/`, `server/`, `src/`, `workflows/`
